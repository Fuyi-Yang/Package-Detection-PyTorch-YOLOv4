...
if num_classes == 20:
    ...
    namesfile = './data/Chess-Pieces/chess.names'
...
def get_args():
    ...
    parser.add_argument('-cfgfile', type=str, default='./model/yolov4.conv.137.pth',
                        help='path of cfg file', dest='cfgfile')
    parser.add_argument('-weightfile', type=str,
                        default='./checkpoints/Yolov4_epoch200.pth',
                        help='path of trained model.', dest='weightfile')
    parser.add_argument('-imgfile', type=str,
                        default='./data/valid/00000.jpg',
